    ...
    return (
        <div className="relative">
            <section className="relative bg-gray-200">
                ...
                <div className="relative mx-auto max-w-7xl bg-gray-200 lg:grid lg:grid-cols-2">
                    <div className="flex items-center px-4 pb-16 bg-white  sm:px-6 lg:px-8 lg:pb-24 xl:pr-12">
                        <div className="max-w-lg mx-auto lg:mx-0">
                          
                            <img
                    className="inline w-auto h-8 sm:h-10 lg:h-32"
                    src={SpaceIcon}
                    alt="shape-1"
                  />
                    ...
                    <div className="relative flex items-center px-4 py-16 bg- sm:px-6 lg:pb-24 xl:pl-12">
                        <div className="relative w-full max-w-lg mx-auto lg:max-w-none">
                            <p className="text-lg font-bold text-white">Space Types we Offer</p>
