...
interface ContentSectionsProps {
  imageSrc: string; // Assuming imageSrc is a URL or path to an image
  heading: string;
  paragraph: string;
  isReverse: boolean;
...
const ContentSections:React.FC<ContentSectionsProps> = ({ imageSrc, heading, paragraph, isReverse, animationDelay }) => {
  const variants = {
    hidden: {
