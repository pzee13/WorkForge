...
function ImageTextCard({ imageUrl, text }: SpaceTypeProps) {
  return (
    <div className="relative flex items-center justify-center bg-gray-200 mt-10 mx-20"> {/* Added mx-20 for horizontal margin */}
      <div className="absolute inset-0 backdrop-filter backdrop-blur-md"></div> {/* Glass effect */}
      <div className="z-10 bg-white rounded-lg shadow-md overflow-hidden flex flex-col md:flex-row relative">
        ...
        <div className="p-4 w-full md:w-1/2 flex items-center justify-center">
          <p className="text-3xl md:text-6xl font-semibold text-center text-shadow-xl font-lato text-black">{text}</p> {/* Text color */}
        </div>
      </div>
    </div>
  );
