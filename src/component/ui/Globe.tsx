...
export function Globe({ globeConfig, data }: WorldProps) {
    const [globeData, setGlobeData] = useState<any[]>([]); // Update the state type to any[]
  
    const globeRef = useRef<ThreeGlobe>(null); // Update ref type to ThreeGlobe
    ...
    useEffect(() => {
      ...
      const _buildData = () => {
        ...
        for (let i = 0; i < arcs.length; i++) {
          ...
          // Validate positions to ensure they are not NaN
  ...
  export function World(props: WorldProps) {
    ...
    return (
      <Canvas scene={scene} style={{ width: '100%', height: '450px' }} camera={new PerspectiveCamera(40, aspect, 180, 1800)}>
        <WebGLRendererConfig />
