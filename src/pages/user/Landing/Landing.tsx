...
// import landImage from "../../../assets/images/LandingUser/81248.jpg";
// import baseImage from "../../../assets/images/LandingUser/greenback.jpg"
...
// import assistance from "../../../assets/images/LandingUser/logo/customer-service.png";
// import beverages from "../../../assets/images/LandingUser/logo/cold-drink (1).png";
...
// import ContentSection from '../../../component/user/landing/ContentSection'
...
//             // setSpaces(res.data);
//             const coords = res.data.map((space: { latitude: string; longitude: string; }, index: number) => ({
...
//       <div className=" bg-backgroundCol items-center letter-spacing-custom">
...
//           src={baseImage}
//           alt="Background"
//           className="absolute z-[-20] inset-0 w-full h-full bg-gradient-to-b from-black via-transparent to-transparent "
//         />
//         <div className="absolute inset-0 z-[-20]   bg-gradient-to-b  from-black via-transparent to-transparent"></div>
...
//         viewport={{ once: true }}
//         className="mb-10">
//                 <div className="flex justify-center z-10 items-center mt-8 md:mt-20">
//                     <p className="text-3xl md:text-5xl font-lato font-bold rounded-lg text-white">
...
//                     <p className="text-3xl md:text-5xl font-lato font-bold text-white">
...
//       <div className="w-1/6 mx-auto overflow-hidden bg-white rounded shadow-xl">
//       <div className="p-8">
//         <p className="text-2xl font-bold text-center text-gray-900">Jenny-Retro Art</p>
//         <p className="mt-6 text-xs text-center font-medium tracking-widest text-gray-500 uppercase">Reserved Price</p>
        
//           <p className="text-s font-bold  text-gray-900">JobName : Developer</p>
...
//             href="#"
//             title=""
//             className="inline-flex items-center justify-center px-4 py-4 text-sm font-bold text-gray-900 transition-all duration-200 bg-transparent border border-gray-300 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 rounded-full"
//             role="button"
//           >
//             Edit 
//           </a>
...
//       <section className="p-6 my-6  dark:text-white">
// 	<div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
// 		<div className="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-white  dark:text-customGreen">
...
// <section className="p-6  dark:text-white mb-6">
// 	<div className="container p-4 mx-auto text-center">
// 		<h2 className="text-4xl font-bold">Trusted by the industry leaders</h2>
// 	</div>
// 	<div className="container flex flex-wrap justify-center mx-auto dark:text-white">
...
// {/* 
// <div className="">
//     <h1 className="text-2xl text-center font-lato font-bold text-white">We are all around the world</h1>
//         <World
//         globeConfig={{
//           pointSize: 1,
//           atmosphereColor: "",
...
// 	</div>
// </section> */}
//                 <section className="dark:bg-backgroundCol dark:text-white">
